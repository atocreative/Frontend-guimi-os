...
import { ConsolidadoDashboard } from "@/components/financeiro/consolidado-dashboard"

interface PageProps {
  searchParams: Promise<Record<string, string | undefined>>
}

export default async function FinanceiroConsolidadoPage({ searchParams }: PageProps) {
